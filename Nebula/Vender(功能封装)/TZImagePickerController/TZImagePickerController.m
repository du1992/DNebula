...
//    self.navigationBar.tintColor = [UIColor whiteColor];
    ...
    // 导航栏标题字体
    self.navigationBar.titleTextAttributes = @{NSFontAttributeName:[UIFont systemFontOfSize:12.0], NSForegroundColorAttributeName:[UIColor blackColor]};
    
   [self.navigationBar setBackgroundImage:[UIImage createImageWithColor:UIColorFromRGBValue(0X1966ff)] forBarMetrics:UIBarMetricsDefault];
